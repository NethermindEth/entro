...
def test_start_before_all_end_after_all(setup_backfills, create_debug_logger):
    ...
    range_plan.mark_finalized(2, DEFAULT_KWARGS)
    assert range_plan.add_backfill.start_block == 5_000_000
    ...
    range_plan.mark_finalized(3, DEFAULT_KWARGS)
    assert range_plan.add_backfill.start_block == 5_000_000
...
def test_extend_fail_before(setup_backfills):
    ...
    range_plan.mark_failed(range_index=0, final_block=13_750_000, range_kwargs=DEFAULT_KWARGS)
...
def test_extend_fail_after(setup_backfills):
    ...
    range_plan.mark_failed(range_index=1, final_block=15_250_000, range_kwargs=DEFAULT_KWARGS)
...
def test_extend_fail_after_single(setup_backfills):
    ...
    extend_plan.mark_failed(range_index=0, final_block=15_250_000, range_kwargs=DEFAULT_KWARGS)
...
def test_join_fail_before(setup_backfills):
    ...
    fail_before_plan.mark_failed(range_index=0, final_block=5_500_000, range_kwargs=DEFAULT_KWARGS)
...
def test_join_fail_mid_plan(setup_backfills):
    ...
    fail_mid_plan.mark_finalized(0, DEFAULT_KWARGS)
    fail_mid_plan.mark_failed(range_index=1, final_block=15_500_000, range_kwargs=DEFAULT_KWARGS)
...
def test_join_fail_late_plan(setup_backfills):
    ...
    fail_late_plan.mark_finalized(0, DEFAULT_KWARGS)
    fail_late_plan.mark_finalized(1, DEFAULT_KWARGS)
    fail_late_plan.mark_failed(range_index=2, final_block=18_500_000, range_kwargs=DEFAULT_KWARGS)
...
def test_start_after_first_end_after_all(setup_backfills):
    ...
    result.mark_finalized(0, DEFAULT_KWARGS)
    result.mark_finalized(1, DEFAULT_KWARGS)
    result.mark_failed(2, 17_500_000, DEFAULT_KWARGS)
...
def test_start_before_all_end_before_last(setup_backfills):
    ...
    result.mark_finalized(0, DEFAULT_KWARGS)
    result.mark_finalized(1, DEFAULT_KWARGS)
    result.mark_finalized(2, DEFAULT_KWARGS)
...
def test_extend_second_both_sides(setup_backfills):
    ...
    result.mark_finalized(0, DEFAULT_KWARGS)
    result.mark_failed(1, 15_250_000, DEFAULT_KWARGS)
...
def test_start_in_gap_end_in_gap(setup_backfills):
    ...
    result.mark_failed(0, 11_000_000, DEFAULT_KWARGS)
    assert len(result.remove_backfills) == 0
