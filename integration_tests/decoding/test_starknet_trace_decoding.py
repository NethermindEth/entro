...
async def test_decode_tx_traces(starknet_rpc_url):
    ...
    assert call_traces[1].contract_address == to_bytes("0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7")
    assert call_traces[1].decoded_outputs == [True]
    assert call_traces[1].decoded_inputs == {"recipient": "0x019252b1deef483477c4d30cfcc3e5ed9c82fafea44669c182a45a01b4fdb97a", "amount": 32000000000000000}

    assert call_traces[2].function_name == "watch"
    assert call_traces[2].contract_address == to_bytes("0x022993789c33e54e0d296fc266a9c9a2e9dcabe2e48941f5fa1bd5692ac4a8c4")
