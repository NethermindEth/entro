...
class TestMint:
    ...
    def test_mint_fails_if_amount_exceeds_max(self, random_address, tick_spacing):
    ...
    def test_mint_fails_if_amount_is_zero(self, random_address, tick_spacing):
        pool = UniswapV3Pool(tick_spacing=tick_spacing)
        with pytest.raises(UniswapV3Revert):
            pool.mint(
                random_address(),
    ...
    def test_does_not_write_observation(self, random_address, tick_spacing):
    ...
    def test_writes_an_observation(self, random_address, tick_spacing):
        start_time = int(datetime.datetime.now().timestamp())
        pool = UniswapV3Pool(
            tick_spacing=tick_spacing,
            initial_timestamp=start_time,
