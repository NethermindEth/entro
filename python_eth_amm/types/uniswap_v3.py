...
class PoolImmutables:
    ...
    """
    initialization_block: int | None = None
    """
        Block number that the pool was initialized.  This value is set to None if the pool has not been initialized
        from a chain
    """
...
class SwapStep:
    ...
    sqrt_price_start: int | None = None
    tick_next: int | None = None
    sqrt_price_next: int | None = None
