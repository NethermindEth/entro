...
class SqrtPriceMathModule:
    ...
    def get_amount_0_delta(
        ...
        if cls.exact_math:
            ...
            result = call_evm_contract(
                cls.evm_instance, cls.deploy_address, payload, SqrtPriceMathRevert
            )
        ...
        return int(
            ...
            / (sqrt_upper * sqrt_lower / SQRT_X96)
        )
    ...
    def get_next_sqrt_price_from_amount_0_rounding_up(
        ...
        sqrt_price_next = int(
            ...
            / (liquidity + ((1 if add else -1) * (amount * sqrt_price)) / SQRT_X96)
        )
    ...
    def get_next_sqrt_price_from_amount_1_rounding_down(
        ...
        sqrt_price_next = int(
            sqrt_price + (1 if add else -1) * (amount * SQRT_X96 / liquidity)
        )
