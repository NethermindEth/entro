...
def query_abis(db_session: Session, abi_names: list[str] | None = None) -> list[ContractABI]:
    """
    ...
    query = (
        ...
        .filter(ContractABI.abi_name.in_(abi_names) if abi_names else ContractABI.abi_name != None)
